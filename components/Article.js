...
function articleMaker(article) {
  ...
  articleContainer.appendChild(para2);
  articleContainer.appendChild(para3);
...
const eachArticle = data.map(articleContainer => {
  return articleMaker(articleContainer);
})

eachArticle.forEach(articleContainer => {
